...
def display():
    ...
    render_text(10, window_height - 20, f"Translation | Axis: {axis} | Shape: {shape_index+1} | Proj: {projection}")
    render_text(10, window_height - 40, f"T({tx:.2f},{ty:.2f},{tz:.2f})")
...
def main():
    ...
    glutCreateWindow(b"Lab 5 - Translation")
    init_gl()
